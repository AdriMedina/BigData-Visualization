...
/** Factory for [[mypackage.BarChart]] instances. */
...
object BarChart {
	...
	*/
	def computeBarChartContinuous(sqlContext: SQLContext, df: DataFrame, colSelected: String, colCount: String, op:Int, idPlot: String) : String = {
		...
		*
		*/
		val res = Graphic("BarChart", colSelected, colCount, listValues.toList)
